...
import type { LessonMetadata } from "@/data/types/lessons";

const lessonData: Record<string, LessonMetadata> = {
  "javascript/variables/lesson-1": {
    language: "javascript",
    section: "variables",
    lessonNumber: 1,
    ...
    learningPrompt:
      "Explain the difference between var, let, and const in JavaScript. When should I use each one?",
    initialCode:
...
export const lessonMetadata: LessonMetadata[] = [
  ...
  },
  {
    ...
    learningPrompt:
      "What is the difference between block scope and function scope? How does hoisting work with different variable declarations?",
    initialCode:
      "function example() {\n  var x = 1;\n  let y = 2;\n  const z = 3;\n  \n  if (true) {\n    var x = 10;\n    let y = 20;\n    console.log(x, y, z);\n  }\n  \n  console.log(x, y, z);\n}\n\nexample();",
  },
  {
    ...
    learningPrompt:
      "What are the primitive data types in JavaScript? How does type coercion work?",
    initialCode:
  ...
  // JavaScript Conditionals
  {
    ...
    learningPrompt:
      "How do if statements work in JavaScript? What are the different ways to write conditions?",
    initialCode:
  ...
  },
  {
    ...
    learningPrompt:
      "When should I use else if vs switch statements? What are the pros and cons of each?",
    initialCode:
  ...
  // JavaScript Loops
  {
    ...
    learningPrompt:
      "How do for loops work? What's the difference between for, for...of, and for...in loops?",
    initialCode:
  ...
  },
  {
    ...
    learningPrompt:
      "When should I use while vs do-while loops? How do I avoid infinite loops?",
    initialCode:
  ...
  // JavaScript Functions
  {
    ...
    learningPrompt:
      "What are the different ways to declare functions in JavaScript? What's the difference between function declarations and function expressions?",
    initialCode:
  ...
  },
  {
    ...
    learningPrompt:
      "What are arrow functions? When should I use them vs regular functions? What about 'this' binding?",
    initialCode:
  ...
  // TypeScript Variables
  {
    ...
    learningPrompt:
      "How do type annotations work in TypeScript? What are the benefits of using them?",
    initialCode:
  ...
  },
  {
    ...
    learningPrompt:
      "How does TypeScript type inference work? When should I rely on it vs explicit annotations?",
    initialCode:
  ...
  // Python Variables
  {
    ...
    learningPrompt:
      "How do variables work in Python? What are the naming conventions and best practices?",
    initialCode:
  ...
  },
  {
    ...
    learningPrompt:
      "What are the main data types in Python? How does dynamic typing work?",
    initialCode:
  ...
  // Java Variables
  {
    ...
    learningPrompt:
      "How do variable declarations work in Java? What are the primitive data types?",
    initialCode:
