...
export function CodeEditor({ value, onChange, language = 'typescript', mode = 'standard', className, statusBarRef }) {
    ...
    return (_jsx("div", { className: "h-full w-full border rounded-md overflow-hidden " + (className ?? ''), children: _jsx(Editor, { height: "100%", defaultLanguage: language, value: value, onChange: handleChange, onMount: handleMount, options: {
